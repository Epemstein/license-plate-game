            ...
            container.innerHTML = `
                <div style="max-width:400px;margin:30px auto;border:2px solid #1a1714;border-radius:10px;overflow:hidden;box-shadow:6px 6px 0 #9370db;">
                    <div style="padding:32px 32px 28px;text-align:center;">
                        <div style="font-family:'Newsreader',Georgia,serif;font-size:1.8rem;font-weight:800;margin-bottom:16px;">Create your account</div>
                        <div style="font-family:'Newsreader',Georgia,serif;font-style:italic;color:#756e5c;font-size:0.95rem;margin-bottom:28px;">Free forever — keep your stats, streaks, and a spot on the leaderboards.</div>
                        ...
                        <div style="font-size:0.8rem;color:#756e5c;margin-top:8px;font-style:italic;">Links to your iOS app account</div>
                    </div>
                </div>
            `;
        }
