        ...
        if (currentUser) {
            ...
            container.innerHTML = `
                <div style="margin-top:60px;">
                    ...
                    <div style="font-size:1rem;color:#756e5c;margin-bottom:24px;">Sign in to save your scores and compete on the leaderboard.</div>
                    <div style="display:flex;flex-direction:column;gap:10px;max-width:280px;margin:0 auto;">
                        <button class="profile-signin-btn" onclick="signInWithApple()">
                            &#63743; Sign In with Apple
                        </button>
                        <button class="profile-signin-btn" onclick="signInWithGoogle()" style="background:#ffffff;color:#1a1714;border:2px solid #1a1714;">
